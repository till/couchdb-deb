...
config_files() -> [lists:nth(1,test_util:config_files())].

bad_perms() ->
    test_util:local_file("172-os-daemon-errors.1.sh").

die_on_boot() ->
    test_util:local_file("172-os-daemon-errors.2.sh").

die_quickly() ->
    test_util:local_file("172-os-daemon-errors.3.sh").

can_reboot() ->
    test_util:local_file("172-os-daemon-errors.4.sh").
